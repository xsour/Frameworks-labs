...
class App {
    constructor() {
        this.addBook = () => {
            ...
            const errors = validation_1.Validation.validateBook(title, author, year.toString());
        ...
        this.showBorrowBookModal = (bookId) => {
            modal_1.Modal.showBorrowBookModal(bookId, (userId) => this.borrowBook(bookId, userId));
        };
